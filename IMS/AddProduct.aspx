     ...
     <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="GreenRainCode" CssClass="text-danger" ErrorMessage="The product greenrain Code field is required." />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="ProductDept" CssClass="text-danger" ErrorMessage="The product department field is required." />
            </div>
        </div>  
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button ID="btnCreateProduct" runat="server" OnClick="btnCreateProduct_Click"  Text="ADD" CssClass="btn btn-default" />
